...
--
  ...
  * There is baseline level of research quality which must be first established prior to other researchers using out methods or results.
  
--

  * This also includes the longevity of our research.
...
While these goal is partially achieved by the increase in open access to data and materials evidenced by the increase in Open Science Framework's badges, the quality and usability of these resources can still be in question.
...
R Projects:
  ...
  * https://www.tidyverse.org/blog/2017/12/workflow-vs-script/
    * This last link also explains the rationale for using `here::here()`
